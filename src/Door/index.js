...
const Door = (props) => {
  ...
  <DoorContainer>
    <svg
      ...
      onMouseEnter={() => intervalID = setInterval(() => props.changeTheme(), 200)}
    ...
    >
      <g>
        ...
        <path d="M362.62,185l95.24-22.63L429.21,79.91l-97.27,45.3A126.93,126.93,0,0,1,362.62,185Z"
              transform="translate(-18.33)"/>
        <path d="M144.26,125.21L47,79.91,18.33,162.35,113.57,185A127,127,0,0,1,144.26,125.21Z"
              transform="translate(-18.33)"/>
        <path d="M325.91,0H150.28L178,98.92a127,127,0,0,1,120.21,0Z" transform="translate(-18.33)"/>
        <path d="M361.42,213.73h53.73V179.15L360,192.25A123.51,123.51,0,0,1,361.42,211v2.74Z"
              transform="translate(-18.33)"/>
        <rect x="42.71" y="280.56" width="53.73" height="34.22"/>
        <rect x="343.09" y="280.56" width="53.73" height="34.22"/>
        <path d="M173.3,106.12L149.45,21,99,27,74.62,85.65,152.77,122A124.08,124.08,0,0,1,173.3,106.12Z"
              transform="translate(-18.33)"/>
        <path d="M323.42,122l77.31-36L374.39,27l-47.8-5.5-23.7,84.58A124.11,124.11,0,0,1,323.42,122Z"
              transform="translate(-18.33)"/>
